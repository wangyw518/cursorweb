...
async function main() {
  ...
  await evalExpr('(function(){var g=window.__taiqiu; var b=g.session.ui.aiSplash; g.sessionMod.handlePointerDown(g.session, b.x+8, b.y+8); g.session.best=0; g.session.skinProgress=0;})()');
  await sleep(80);
